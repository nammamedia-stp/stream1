#!/usr/bin/env bash
# ==============================================================================
# StreamPulse Kiosk Suite - Automated Rollback & Restore Engine
# Location: /opt/streampulse/bin/restore.sh
...
echo "========================================================================"
echo "          StreamPulse Kiosk Suite - System Restore Engine               "
echo "========================================================================"
...
# 1. Stop and disable new kiosk services
echo "[1/6] Stopping StreamPulse Kiosk service..."
