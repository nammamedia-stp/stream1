#!/usr/bin/env bash
# ==============================================================================
# StreamPulse Kiosk Suite - Safe Uninstallation Script
# Location: /opt/streampulse/bin/uninstall.sh
# Removes kiosk services safely without deleting personal files or working player
# ==============================================================================
...
echo "========================================================================"
echo "          StreamPulse Kiosk Suite - Safe Uninstaller                   "
echo "========================================================================"
...
echo "  - RustDesk and Audio configurations untouched"
