#!/usr/bin/env bash
# ==============================================================================
# StreamPulse Kiosk Launcher - Single Authoritative Browser Launcher
# Location: /opt/streampulse/bin/dashboard-kiosk.sh
# Target: Raspberry Pi OS 64-bit / Debian 13 (Trixie) ARM64 / Labwc Session
# ==============================================================================
...
# Ensure log directory exists or fallback to /tmp
...
if pgrep -f "user-data-dir=$BROWSER_PROFILE_DIR" >/dev/null 2>&1; then
  log "Notice: An existing Chromium instance using profile $BROWSER_PROFILE_DIR is already running."
...
# CRITICAL KEYRING REQUIREMENT:
# --password-store=basic MUST be inside the browser arguments array to suppress GNOME/KDE keyring popups.
